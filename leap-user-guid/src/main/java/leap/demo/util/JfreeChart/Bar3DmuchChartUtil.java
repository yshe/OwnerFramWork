...
public class Bar3DmuchChartUtil {
	
	private static CategoryDataset getCategoryDataset() {
		  // 行关键字
		final String series1 = "最瘦的";
		final String series2 = "最胖的";
		final String series3 = "最黑的";
		//列关键字
	...
	public static JFreeChart getJFreeChart() {
		...
		JFreeChart chart = ChartFactory.createBarChart3D("2016年上半年销售量", // 图表标题
				"月份", 				// x轴标签
				"销售量（单位：个）", 		// y轴标签
				dataset, 				// 数据集
