...
<%@ page import="leap.demo.util.JfreeChart.MuchPieChartUtil"  %>
...
<html>
  ...
  <body>
  	<%
  		JFreeChart chart = MuchPieChartUtil.getJFreeChart();//生成JFreeChart图表对象 
  		MuchPieChartUtil.createPiePlot(chart);
